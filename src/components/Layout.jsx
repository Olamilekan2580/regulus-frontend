...
export default function Layout() {
  ...
  const NavLinks = ({ onClick = () => {} }) => (
    // FIX: Use a real div instead of a fragment so this component owns its flex context.
    // flex-col + flex-1 lets it fill the sidebar. min-h-0 is critical — without it,
    // a flex child won't shrink below its content height, so the nav can't scroll
    // and the footer gets pushed out of view.
    <div className="flex flex-col flex-1 min-h-0">
      ...
      {/* FOOTER: shrink-0 ensures it never collapses. mt-auto is removed because
          the nav's flex-1 already pushes this to the bottom naturally. */}
