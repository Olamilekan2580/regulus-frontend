      ...
      <div className="max-w-md w-full bg-white rounded-3xl shadow-2xl p-10">
        ...
        <div className="flex flex-col gap-3">
          <button
            ...
            className="w-full flex justify-center items-center py-3.5 px-4 rounded-xl shadow-sm text-sm font-bold text-navy bg-white border border-gray-200 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-200 transition-all disabled:opacity-70"
          >
          ...
          <button
            ...
            disabled={oauthLoading || loading}
            className="w-full flex justify-center items-center py-3.5 px-4 rounded-xl shadow-sm text-sm font-bold text-white bg-[#24292F] hover:bg-[#1b1f23] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#24292F] transition-all disabled:opacity-70"
          >
            {oauthLoading ? 'Connecting...' : (
              <>
